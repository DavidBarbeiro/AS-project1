		...
		while (true) {
			try {
				...
				for (i = 0; i < IdLength; i++) {
					databyte = listPipeIn.get("MiddleFilter")
							.ReadFilterInputPort(); // This is where we read the
				...
				/****************************************************************************
				 * // Here we pick up a measurement (ID = 4 in this case), but
				...
				if (id == 4) {
					System.out
							.print(TimeStampFormat.format(TimeStamp.getTime())
									+ " ID = " + id + " "
			 ...
			 ********************************************************************************/
				...
				listPipeIn.get("MiddleFilter").closePort();
				System.out.print("\n" + this.getName()
